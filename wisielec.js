...
haslo=haslo.toUpperCase(); //duże litery 
...
function wypisz_haslo(){
    document.getElementById("plansza").innerHTML=haslo1; //inner=zawartość diva
}
...
String.prototype.ustawZnak=function(miejsce,znak){
    ...
    else return this.substr(0,miesjsce)+znak+this.substr(miesjsce+1);
}
